...
class QuizScreen2 extends StatefulWidget {
  ...
  const QuizScreen2({super.key, required this.part2qData});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _mainData(
                          title: widget.part2qData.auto,
                          image: Assets.iconsAuto),
                    ],
                  ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      _malumotlar(Assets.iconsDvigatel,
                          "Motor: ${widget.part2qData.mator}"),
                      _malumotlar(Assets.iconsMator_xajmi,
                          "Motor hajmi: ${widget.part2qData.mator_xajmi}"),
                      _malumotlar(Assets.iconsKuzof,
                          "Kuzof: ${widget.part2qData.kuzof}"),
                      _malumotlar(Assets.iconsYoqilgi_sari,
                          "Yoqilg'i sarfi: ${widget.part2qData.yoqilgi_sarfi}"),
